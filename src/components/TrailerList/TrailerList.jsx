      ...
      { !isSearch && trailerItems.length > 0 
        &&  <div className={styles.inner}> 
              <div className={styles.block}> 
                <iframe key={trailerItems[0].id} width="100%" height="500" src= {`https://www.youtube.com/embed/${trailerItems[0].key}`} title={trailerItems[0].name} allowFullScreen loading="lazy"/>
              </div>
